...
3. **Quanto defende?**
4. **Tem Go Again?**
5. **O texto está tentando me enganar?**
...
1. Você quer jogar uma carta que custa **2**.
2. Você dá pitch em uma carta azul.
3. Ela gera **3 recursos**.
4. Você paga 2.
...
1. Você tem 1 ponto de ação.
2. Joga um ataque com **Go Again**.
3. O ataque resolve.
4. Você ganha 1 ponto de ação.
5. Pode jogar outra ação.
...
## Keywords essenciais: o inglês que realmente bate {#keywords-essenciais}
...
> Para regras e formatos oficiais, consulte sempre o [Rules and Policy Center](https://fabtcg.com/rules-and-policy-center/) e a página de [Gameplay Formats](https://fabtcg.com/gameplay-formats/). Regra de card game muda. A certeza humana também, mas essa dói menos no sideboard.
...
1. **Escolha um herói simples.** Evite começar com algo que exige nove janelas de prioridade e um pacto arcano.
2. **Leia a arma e os equipamentos.** Eles ficam na mesa e serão usados várias vezes.
3. **Separe as cartas por custo.** Entenda o que você consegue pagar.
4. **Observe as cores de pitch.** Azul paga o turno; vermelho bate mais; amarelo evita colapso.
5. **Não bloqueie tudo.** Se você defender com a mão inteira, seu turno vira um funeral.
6. **Use arsenal com intenção.** Guarde carta que você consegue jogar.
7. **Pergunte.** Jogador experiente que não ajuda iniciante está cultivando um meta morto.
...
## Erros comuns de iniciante {#erros-comuns}
...
## Como evoluir depois do básico {#como-evoluir}

Depois que você entender a primeira camada, evolua em blocos:

1. **Aprenda seu herói.** Não tente jogar com dez heróis ao mesmo tempo.
2. **Entenda sua curva de pitch.** Saiba quantas azuis seu deck precisa.
3. **Treine defesa.** Bons jogadores vencem muitos jogos bloqueando certo.
4. **Assista partidas.** Mas assista pausando e perguntando “por que ele fez isso?”.
5. **Jogue presencialmente.** FAB brilha na mesa, com conversa, leitura e aquele silêncio delicioso depois de um ataque absurdo.
...
## Conclusão: bem-vindo ao sofrimento organizado {#conclusao}
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Flesh and Blood é difícil de aprender?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Flesh and Blood parece difícil no começo por causa das zonas, keywords e decisões de pitch, mas o básico fica claro quando o jogador entende herói, mão, arsenal, pitch, ataque e defesa."
      }
    },
    {
      "@type": "Question",
      "name": "Preciso gastar muito para começar em Flesh and Blood?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Não necessariamente. Formatos mais acessíveis, decks introdutórios e listas casuais ajudam novos jogadores a começar sem depender de cartas caras."
      }
    },
    {
      "@type": "Question",
      "name": "O que devo aprender primeiro em Flesh and Blood?",
      "acceptedAnswer": {
        "@type": "Answer",
